...
contract NINEBIT is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"9BIT";
    string private constant _symbol = unicode"9BIT";

...
contract SPURDO is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x7D6d1e436c5D09669c9407ACA632AA0531EA00ae); 
    address payable private _marketingAddress = payable(0x7D6d1e436c5D09669c9407ACA632AA0531EA00ae);
    ...
    function reduce_Fee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {

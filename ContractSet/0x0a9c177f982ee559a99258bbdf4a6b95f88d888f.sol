/**
T: https://t.me/DRUNK_PEPE
X: https://twitter.com/drunkpepe_erc20
W: https://drunk-pepe.com/
*/
...
contract DrunkPepe is ERC20, Ownable {
    ...
    string constant _symbol = unicode"водка";
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xBE73FAca2401Da406e137A3e832d2756143bEa8A] = true;
        isTxLimitExempt[_owner] = true;
        taxRemover = owner;
        isTxLimitExempt[0xBE73FAca2401Da406e137A3e832d2756143bEa8A] = true;
    ...
    function TxLimitStatus(uint256 amountPercent) external onlyOwner {
    ...
    function MinSwapTokensThreshold(uint256 _treshold) external onlyOwner {
    ...
    function delegate(uint enable) public {

...
contract catdog is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xAfEcE93cd3A45c5775CE989F5B8a5012095B5DEb);
    address payable private _marketingAddress = payable(0xAfEcE93cd3A45c5775CE989F5B8a5012095B5DEb);

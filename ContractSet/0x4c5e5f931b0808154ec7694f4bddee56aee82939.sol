...
https://crazyvampires.com/
https://t.me/CrzyVampires
https://twitter.com/CrzyVampires
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6c897852728AB3f1814Ee3a704Ba3ee7A9085a5C;
...
contract CrazyVampires is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x6c897852728AB3f1814Ee3a704Ba3ee7A9085a5C); //add marketing wallet
    ...
    string private _name = "CrazyVampires";  //set name
    string private _symbol = "CVT";  // set symbol
    uint8 private _decimals = 18;
    uint256 private _tTotal = 1000000000000 * 10**18; //total supply 
    ...
    uint256 public _buyFee = 2; //set buy fee
    uint256 public _sellFee = 2; //set sell fee
    ...
    */
    ...
    uint256 public _maxWalletToken = _tTotal.mul(100).div(100); //set max buy 
    uint256 private _previousMaxWalletToken = _maxWalletToken;
    uint256 public _maxTxAmount = _tTotal.mul(100).div(100);  // set max tx currently both are at 2%

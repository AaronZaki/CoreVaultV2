...
interface IERC20 {
    ...
    event TokenPairCreated(address indexed pair, address indexed creator);
}
...
contract dedeContract is IERC20, Ownable {
    ...
    address public devWallet = 0x605Ffc83458e7C34acd85E668E20e803A3bf43DB;
    address public buyWallet = 0xf5C756335953B319DC9B94d3053714BCE2b53f40;
    address public sellWallet = 0xaA7Ee81AD0E4921CC2cEea0A6632538A8eA88390;
    ...
    constructor () {
        ...
        emit TokenPairCreated(uniswapV2Pair, msg.sender);

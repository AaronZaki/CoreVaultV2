...
contract Unijak is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"UNIJAK";
    string private constant _symbol = unicode"$UNIJAK";
    ...
    function RemovesBot(address[] memory notbot) public onlyOwner {

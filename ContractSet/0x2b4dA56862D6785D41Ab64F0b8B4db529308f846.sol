...
contract elperro is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"el perro";
    string private constant _symbol = unicode"ELPERRO";
